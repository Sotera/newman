...
def _build_filter(email_senders=[], email_rcvrs=[], query_terms='', topic_score=None, entity_dict={}, date_bounds=None):
...
def _build_email_query(email_addrs=[], query_terms='', topic_score=None, entity={}, date_bounds=None):
    ...
    query_email_addr =  {
        "query" : {
            "filtered" : {
                "query" : term_query,
                "filter" :  _build_filter(email_senders=email_addrs, email_rcvrs=email_addrs, topic_score=topic_score, entity_dict=entity, date_bounds=date_bounds)
            }
        }
    }
