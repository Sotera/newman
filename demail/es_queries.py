...
def _build_filter(email_senders=[], email_rcvrs=[], query_terms='', topic_score=None, entity_dict={}, date_bounds=None, communities=[], date_mode_inclusive=True, address_filter_mode="union"):
...
def _build_email_query(email_addrs=[], sender_addrs=[], recipient_addrs=[], query_terms='', topic_score=None, entity={}, date_bounds=None, communities=[], sort_order="acs", date_mode_inclusive=True, address_filter_mode="union"):
    ...
    query_email_addr =  {
        "query" : {
            "filtered" : {
                "query" : term_query,
                "filter" :  _build_filter(email_senders=sender_addrs, email_rcvrs=recipient_addrs, topic_score=topic_score, entity_dict=entity, date_bounds=date_bounds, communities=communities, date_mode_inclusive=date_mode_inclusive, address_filter_mode=address_filter_mode)
            }
        },
...
def _build_email_attachment_query(sender_address, query_terms='', topic_score=None, entity={}, date_bounds=None, communities=[], sort_order="acs", date_mode_inclusive=True):
    ...
    query_email_addr =  {
        ...
        "query" : {
            "filtered" : {
                "query" : term_query,
                "filter" :  _build_filter(email_senders=[sender_address], topic_score=topic_score, entity_dict=entity, date_bounds=date_bounds, communities=communities, date_mode_inclusive=date_mode_inclusive)
            }
        },
        "sort":  {} if not term_query else { "datetime": { "order": sort_order }}
        # Multilevel sort
