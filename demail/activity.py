...
def getAttachCount(*args, **kwargs):
    ...
    if account_id == 'all' :
        activity = get_attachment_activity("sample", account_id=data_set_id, query_function=attachment_histogram, sender_email_addr="", start=start_datetime, end=end_datetime, interval="week")
