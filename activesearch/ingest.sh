...
perl import_database.pl -file=$RUN_DIR/demail/emails/$EMAIL_TARGET/output.csv -database=$AS_DATABASE -database_username=$AS_DATABASE_USERNAME -database_password=$AS_DATABASE_PASSWORD
