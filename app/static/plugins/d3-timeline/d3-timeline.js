...
(function () {
  d3.timeline = function() {
    ...
    var hover = function () {},
        ...
        tickFormat = { format: d3.time.format("%I %p"), //d3.time.format("%Y-%m-%d"),
          tickTime: d3.time.hours,//tickTime: d3.time.months,
          tickInterval: 1,
          tickSize: 6, //tickSize: 4,
          tickValues: null
        },
        colorCycle = d3.scale.category20c(), //colorCycle = d3.scale.category20(),
        ...
        stacked = false,
        rotateTicks = false,
        timeIsRelative = false, //timeIsRelative = true,
        ...
        showAxisNav = false,
        showAxisCalendarYear = false, //showAxisCalendarYear = false,
        axisBgColor = "white",
        chartData = {}
      ;
