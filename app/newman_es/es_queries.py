...
def _build_filter(ingest_ids=[], email_senders=[], email_rcvrs=[], qs='', topic=None, entity_dict={}, date_bounds=None, community=[], date_mode_inclusive=True, address_filter_mode="union", starred=None, numbers=[], number_type='', phone_numbers=[], has_phone_number_filter=False, has_exif_geo_filter=False, has_geo_xoip_filter=False, encrypted=None, attachment_hash=None):
    ...
    # app.logger.debug("====================================(query: %s)" % (address_filter))
    ...
    # app.logger.debug("====================================2(query: %s)" % (bool_filter))
    ...
    # app.logger.debug("====================================3(query: %s)" % (filter))
...
def _build_email_query(ingest_ids=[], email_addrs=[], sender_addrs=[], recipient_addrs=[], qs='', topic=None, entity={}, date_bounds=None, community=[], sort_mode="default", sort_order="asc", date_mode_inclusive=True, address_filter_mode="union", attachments_only=False, encrypted=None, starred=None, numbers=[], number_type='', phone_numbers=[], has_phone_number_filter=False, has_exif_geo_filter=False, has_geo_xoip_filter=False, attachment_hash=None):
    ...
    # Everything sorted by date, but sort score still returned so that UI can reshuffle
